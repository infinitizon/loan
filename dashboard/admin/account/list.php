...
<td class="text-center"><a href="<?php echo WEB_ROOT; ?>admin/account/?view=detail&accId=<?php echo $acc_id; ?>"><?php echo $acc_no; ?></a></span></td>
...
<td class="text-center"><a href="javascript:viewAccountStatement(<?php echo $id; ?>, <?php echo $acc_no; ?>);">Statement</a><td>
