...
$sql = "SELECT id, fname, lname, phone FROM tbl_users
        WHERE id = $userId";
$result = dbQuery($sql);		
...
<form action="processUser.php?action=phone" method="post" >
...
<input class="form-control"  name="old_phone" type="text"  value="<?php echo $phone; ?>" id="old_phone"  readonly="readonly">
