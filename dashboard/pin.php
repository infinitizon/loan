...
<head>
<title>Account Pin | <?php echo $site_title; ?></title>
<meta charset="utf-8">
...
<h5 class="text-center text-muted font-weight-normal mb-4">Account Pin</h5>
...
<input type="password"  name="accpin" class="form-control">
<div class="clearfix"></div>
</div>
